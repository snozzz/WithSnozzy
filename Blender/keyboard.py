...
# 键盘尺寸（米）。照普通紧凑键盘来。
WIDTH, DEPTH, BASE_H = 0.42, 0.135, 0.016
# 键帽
COLS, ROWS = 15, 5
...
#
# **往前推、往她右手边挪**，是为了把手腕从"拧着"救回来。原来键盘在
# (0.055, -0.40)：手腕离肩只有 32 厘米，小臂几乎横着；而键盘中心还偏在
# 她左边 5.5 厘米，右手要横过身体中线去够，实测右腕扭了 57.5°（左腕才 13°）。
# 推到 (-0.05, -0.45) 之后小臂顺下来，两只手各自落在自己肩膀下面，
# 两腕 25.8° / 27.7°。**别再往前推**：-0.50 时腕角还能再好两三度，
# 但手腕要伸到臂长的 89%，胳膊几乎拉直，看着比扭腕还怪。
CENTRE = Vector((-0.05, -0.45, DESK_Z))
# 转角从 -14° 收到 -8°：手要摆进键盘的坐标系（第 33 条），于是键盘转多少、
# 手腕就得替躯干吃掉多少——躯干没跟着转。实测两只腕的角度之和基本是定值，
# 转角只决定这笔账怎么摊在左右手上，-8° 是两边都不难看的位置。
...
def home_row(side, spread=0.090, back=0.085):
    ...
    `spread` 要比肩宽略宽（肩距 15.4 厘米，这里两腕 18 厘米）。手腕比肩窄
